...
const Popup = forwardRef<PopupHandle, PopupProps>(({ children, onClose }, ref) => {
...
return (
  <div className={`popup ${(isOpen.value ? 'open' : null)} ${isClosing.value ? 'closing' : null}`} onClick={onClickOverlay} style={ { transition: transTimeS } }>
    <div className="window" style={ { transition: transTimeS } }>
        <div className="buttons">
        <img className="clickable" src="/images/x.png" alt="Close" onClick={() => isOpen.set(false)} />
        </div>
